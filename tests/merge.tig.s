...
L56:
	...
	movl	%ebx, %ebx					# run MOVE statement with src:t131, dst:t122,
	call	getch					# call function getch, putting result in EAX
	movl	%eax, %esi					# move result of getch to desired register:t132
	movl	%esi, %esi					# run MOVE statement with src:t132, dst:t121,
	movl	%esi, (%ebx)					# run MOVE statement with src:t121,t122, dst:
	movl	%ebp, %ebx					# run MOVE statement with src:t101, dst:t133,
	addl	$-168, %ebx					# evaluate PLUS expression src: dst:t133
	movl	%ebx, %ebx					# run MOVE statement with src:t133, dst:t124,
	movl	%ebp, 0(%esp)					# argument 0 for L22 from src:t101,
	call	L22					# call function L22, putting result in EAX
	movl	%eax, %esi					# move result of L22 to desired register:t134
	movl	%esi, %esi					# run MOVE statement with src:t134, dst:t123,
	movl	%esi, (%ebx)					# run MOVE statement with src:t123,t124, dst:
	movl	%ebp, %ebx					# run MOVE statement with src:t101, dst:t135,
	addl	$-172, %ebx					# evaluate PLUS expression src: dst:t135
	movl	%ebx, %ebx					# run MOVE statement with src:t135, dst:t128,
	movl	%ebp, %esi					# run MOVE statement with src:t101, dst:t136,
	addl	$-164, %esi					# evaluate PLUS expression src: dst:t136
	movl	%esi, %esi					# run MOVE statement with src:t136, dst:t126,
	call	getch					# call function getch, putting result in EAX
	movl	%eax, %edi					# move result of getch to desired register:t137
	movl	%edi, %edi					# run MOVE statement with src:t137, dst:t125,
	movl	%edi, (%esi)					# run MOVE statement with src:t125,t126, dst:
	movl	%ebp, 0(%esp)					# argument 0 for L22 from src:t101,
	call	L22					# call function L22, putting result in EAX
	movl	%eax, %esi					# move result of L22 to desired register:t138
	movl	%esi, %esi					# run MOVE statement with src:t138, dst:t127,
	movl	%esi, (%ebx)					# run MOVE statement with src:t127,t128, dst:
	movl	%ebp, %ebx					# run MOVE statement with src:t101, dst:t130,
	movl	%ebp, 0(%esp)					# argument 0 for L23 from src:t101,
	movl	-168(%ebp), %esi					# evaluate MEM expression src:t101, dst:t139
	movl	%esi, 4(%esp)					# argument 1 for L23 from src:t139,
	movl	-172(%ebp), %esi					# evaluate MEM expression src:t101, dst:t140
	movl	%esi, 8(%esp)					# argument 2 for L23 from src:t140,
	call	L23					# call function L23, putting result in EAX
	movl	%eax, %esi					# move result of L23 to desired register:t141
	movl	%esi, %esi					# run MOVE statement with src:t141, dst:t129,
	movl	%ebx, 0(%esp)					# argument 0 for L25 from src:t130,
	movl	%esi, 4(%esp)					# argument 1 for L25 from src:t129,
...
L30:
	...
	movl	%esi, %esi					# run MOVE statement with src:t202, dst:t188,
	movl	16(%ebp), %edi					# evaluate MEM expression src:t101, dst:t203
	movl	%edi, 0(%esp)					# argument 0 for checkNilRecord from src:t203,
	call	checkNilRecord					# call function checkNilRecord, putting result in EAX
	movl	%eax, %edi					# move result of checkNilRecord to desired register:t204
	movl	16(%ebp), %edi					# run MOVE statement with src:t101, dst:t205,
	...
	addl	%edx, %edi					# evaluate PLUS expression src:t206, dst:t205
	movl	(%edi), %edi					# evaluate MEM expression src:t205, dst:t207
	movl	%edi, (%esi)					# run MOVE statement with src:t207,t188, dst:
	movl	%ebx, %esi					# run MOVE statement with src:t114, dst:t208,
	addl	$4, %esi					# evaluate PLUS expression src: dst:t208
	movl	%esi, %esi					# run MOVE statement with src:t208, dst:t192,
	movl	8(%ebp), %edi					# run MOVE statement with src:t101, dst:t191,
	movl	12(%ebp), %ecx					# run MOVE statement with src:t101, dst:t190,
	movl	%ecx, -4(%ebp)					# save pseudo-register f0
	...
	movl	%ecx, -8(%ebp)					# save pseudo-register f1
	movl	%edi, 0(%esp)					# argument 0 for L23 from src:t191,
	movl	-4(%ebp), %edx					# load pseudoreg `f0' to machine reg `%edx'
	movl	%edx, 4(%esp)					# argument 1 for L23 from src:t190,
	movl	16(%ebp), %edi					# run MOVE statement with src:t101, dst:t211,
	...
	movl	%ecx, -4(%ebp)					# save pseudo-register f0
	movl	-4(%ebp), %edx					# load pseudoreg `f0' to machine reg `%edx'
	addl	%edx, %edi					# evaluate PLUS expression src:t212, dst:t211
	movl	(%edi), %edi					# evaluate MEM expression src:t211, dst:t213
	movl	%edi, 8(%esp)					# argument 2 for L23 from src:t213,
	call	L23					# call function L23, putting result in EAX
	movl	%eax, %edi					# move result of L23 to desired register:t214
	movl	%edi, %edi					# run MOVE statement with src:t214, dst:t189,
	movl	%edi, (%esi)					# run MOVE statement with src:t189,t192, dst:
...
L29:
	...
	movl	%esi, %esi					# run MOVE statement with src:t216, dst:t184,
	movl	12(%ebp), %edi					# evaluate MEM expression src:t101, dst:t217
	movl	%edi, 0(%esp)					# argument 0 for checkNilRecord from src:t217,
	call	checkNilRecord					# call function checkNilRecord, putting result in EAX
	movl	%eax, %edi					# move result of checkNilRecord to desired register:t218
	movl	12(%ebp), %edi					# run MOVE statement with src:t101, dst:t219,
	...
	movl	%ecx, -4(%ebp)					# save pseudo-register f0
	movl	-4(%ebp), %edx					# load pseudoreg `f0' to machine reg `%edx'
	addl	%edx, %edi					# evaluate PLUS expression src:t220, dst:t219
	movl	(%edi), %edi					# evaluate MEM expression src:t219, dst:t221
	movl	%edi, (%esi)					# run MOVE statement with src:t221,t184, dst:
	movl	%ebx, %esi					# run MOVE statement with src:t113, dst:t222,
	addl	$4, %esi					# evaluate PLUS expression src: dst:t222
	movl	%esi, %esi					# run MOVE statement with src:t222, dst:t187,
	movl	8(%ebp), %edi					# run MOVE statement with src:t101, dst:t186,
	...
	movl	%ecx, -4(%ebp)					# save pseudo-register f0
	movl	%edi, 0(%esp)					# argument 0 for L23 from src:t186,
	movl	12(%ebp), %edi					# run MOVE statement with src:t101, dst:t225,
	...
	movl	%ecx, -4(%ebp)					# save pseudo-register f0
	movl	-4(%ebp), %edx					# load pseudoreg `f0' to machine reg `%edx'
	addl	%edx, %edi					# evaluate PLUS expression src:t226, dst:t225
	movl	(%edi), %edi					# evaluate MEM expression src:t225, dst:t227
	movl	%edi, 4(%esp)					# argument 1 for L23 from src:t227,
	movl	16(%ebp), %edi					# evaluate MEM expression src:t101, dst:t228
	movl	%edi, 8(%esp)					# argument 2 for L23 from src:t228,
	call	L23					# call function L23, putting result in EAX
	movl	%eax, %edi					# move result of L23 to desired register:t229
	movl	%edi, %edi					# run MOVE statement with src:t229, dst:t185,
	movl	%edi, (%esi)					# run MOVE statement with src:t185,t187, dst:
...
L66:
	...
	movl	%ebx, %ebx					# run MOVE statement with src:t235, dst:t230,
	movl	$4, 0(%esp)					# argument 0 for allocRecord from src:
	call	allocRecord					# call function allocRecord, putting result in EAX
	movl	%eax, %esi					# move result of allocRecord to desired register:t236
	movl	%esi, %esi					# run MOVE statement with src:t236, dst:t110,
	movl	$0, 0(%esi)					# run MOVE statement with src:t110, dst:
	movl	%esi, (%ebx)					# run MOVE statement with src:t110,t230, dst:
	movl	%ebp, %ebx					# run MOVE statement with src:t101, dst:t237,
	addl	$-168, %ebx					# evaluate PLUS expression src: dst:t237
	movl	%ebx, %ebx					# run MOVE statement with src:t237, dst:t232,
	movl	8(%ebp), %esi					# evaluate MEM expression src:t101, dst:t238
	movl	%esi, 0(%esp)					# argument 0 for L0 from src:t238,
	movl	-164(%ebp), %esi					# evaluate MEM expression src:t101, dst:t239
	movl	%esi, 4(%esp)					# argument 1 for L0 from src:t239,
	call	L0					# call function L0, putting result in EAX
	movl	%eax, %esi					# move result of L0 to desired register:t240
	movl	%esi, %esi					# run MOVE statement with src:t240, dst:t231,
	movl	%esi, (%ebx)					# run MOVE statement with src:t231,t232, dst:
...
L26:
	...
	movl	%esi, %esi					# run MOVE statement with src:t247, dst:t234,
	movl	8(%ebp), %edi					# evaluate MEM expression src:t101, dst:t248
	movl	%edi, 0(%esp)					# argument 0 for L22 from src:t248,
	call	L22					# call function L22, putting result in EAX
	movl	%eax, %edi					# move result of L22 to desired register:t249
	movl	%edi, %edi					# run MOVE statement with src:t249, dst:t233,
	movl	%edi, (%esi)					# run MOVE statement with src:t233,t234, dst:
...
L68:
	...
	movl	%ebx, %ebx					# run MOVE statement with src:t264, dst:t251,
	movl	%ebp, 0(%esp)					# argument 0 for L1 from src:t101,
	movl	8(%ebp), %esi					# evaluate MEM expression src:t101, dst:t266
	movl	-164(%esi), %esi					# evaluate MEM expression src:t266, dst:t267
	movl	%esi, 4(%esp)					# argument 1 for L1 from src:t267,
	call	L1					# call function L1, putting result in EAX
	movl	%eax, %esi					# move result of L1 to desired register:t268
	movl	%esi, %esi					# run MOVE statement with src:t268, dst:t250,
	movl	%esi, (%ebx)					# run MOVE statement with src:t250,t251, dst:
	movl	%ebp, 0(%esp)					# argument 0 for L1 from src:t101,
...
L21:
	...
	movl	-164(%ebp), %esi					# run MOVE statement with src:t101, dst:t273,
	imull	$10, %esi					# evaluate MUL expression src: dst:t273
	movl	%esi, %esi					# run MOVE statement with src:t273, dst:t254,
	...
	movl	%esi, %esi					# run MOVE statement with src:t254, dst:t277,
	addl	%edi, %esi					# evaluate PLUS expression src:t253, dst:t277
	movl	%esi, %esi					# run MOVE statement with src:t277, dst:t256,
	...
	movl	%esi, %esi					# run MOVE statement with src:t256, dst:t279,
	subl	%edi, %esi					# evaluate MINUS expression src:t255, dst:t279
	movl	%esi, (%ebx)					# run MOVE statement with src:t279,t257, dst:
	movl	8(%ebp), %ebx					# run MOVE statement with src:t101, dst:t280,
	addl	$-164, %ebx					# evaluate PLUS expression src: dst:t280
	movl	%ebx, %ebx					# run MOVE statement with src:t280, dst:t259,
	call	getch					# call function getch, putting result in EAX
	movl	%eax, %esi					# move result of getch to desired register:t281
	movl	%esi, %esi					# run MOVE statement with src:t281, dst:t258,
	movl	%esi, (%ebx)					# run MOVE statement with src:t258,t259, dst:
	movl	%ebp, 0(%esp)					# argument 0 for L1 from src:t101,
...
L18:
	...
	movl	%ebx, %ebx					# run MOVE statement with src:t295, dst:t288,
	call	getch					# call function getch, putting result in EAX
	movl	%eax, %esi					# move result of getch to desired register:t297
	movl	%esi, %esi					# run MOVE statement with src:t297, dst:t287,
	movl	%esi, (%ebx)					# run MOVE statement with src:t287,t288, dst:
